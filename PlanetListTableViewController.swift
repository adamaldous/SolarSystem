//
//  PlanetNamesTableViewController.swift
//  SolarSystem
//
...
class PlanetNamesTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("PlanetCells", forIndexPath: indexPath)
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
       if let index = sender as? Int {
           let planet = PlanetController.planets[index]
            let detailViewController = segue.destinationViewController as! PlanetDetailViewController
